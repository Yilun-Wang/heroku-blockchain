...
DbGatekeeper = function (hosturl, providerId, RC) {
    ...
    this.submitDataHash = async function (patientID, dataIndex, data, private = true) {
        ...
        if (private)
            ...
            await PPR.methods.updatePermission(dataIndex, 1).send({ from: this.keeperPersonal, gasPrice: '0' });
